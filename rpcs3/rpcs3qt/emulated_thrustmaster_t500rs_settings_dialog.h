...
class emulated_thrustmaster_t500rs_settings_dialog : public QDialog
{
    Q_OBJECT

public:
    emulated_thrustmaster_t500rs_settings_dialog(QWidget* parent = nullptr);
    virtual ~emulated_thrustmaster_t500rs_settings_dialog();
